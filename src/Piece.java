...
public class Piece {
    ...
    public void pawnPromotion(){
        //if pawn reaches row 0 or 7, the pawn can get replaced by any character other than the king
        Scanner myScanner = new Scanner(System.in);
        if(row == 0 && isBlack || row == 7 && isBlack || row == 0 && !isBlack || row == 7 && !isBlack){
            System.out.println("Enter piece you want to promote in place of the pawn:");
            ...
            if(input == "Knight"){
                ...
                System.out.println("Your option is not a chess piece");
            }
            //ask if they want to actually promote and how
        }
